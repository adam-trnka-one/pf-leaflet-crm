...
export const NotificationsTab = () => {
  ...
  return (
    <Card className="bg-card shadow-sm" data-testid="notifications-card">
        ...
        <div className="space-y-4" data-testid="notifications-list">
          <div className="flex items-center justify-between" data-testid="email-notifications-item">
            <div data-testid="email-notifications-info">
              <h4 className="font-medium text-foreground" data-testid="email-notifications-title">{t('notifications.email')}</h4>
              <p className="text-sm text-muted-foreground" data-testid="email-notifications-description">{t('notifications.emailDesc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between" data-testid="push-notifications-item">
            <div data-testid="push-notifications-info">
              <h4 className="font-medium text-foreground" data-testid="push-notifications-title">{t('notifications.push')}</h4>
              <p className="text-sm text-muted-foreground" data-testid="push-notifications-description">{t('notifications.pushDesc')}</p>
            </div>
          ...
          <div className="flex items-center justify-between" data-testid="sms-notifications-item">
            <div data-testid="sms-notifications-info">
              <h4 className="font-medium text-foreground" data-testid="sms-notifications-title">{t('notifications.sms')}</h4>
              <p className="text-sm text-muted-foreground" data-testid="sms-notifications-description">{t('notifications.smsDesc')}</p>
            </div>
