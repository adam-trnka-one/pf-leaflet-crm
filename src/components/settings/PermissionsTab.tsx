  ...
  return (
    <Card className="bg-white shadow-sm" data-testid="permissions-card">
      <CardHeader data-testid="permissions-card-header">
        <CardTitle data-testid="permissions-card-title">Role Permissions</CardTitle>
      </CardHeader>
      <CardContent data-testid="permissions-card-content">
        <div className="space-y-4" data-testid="permissions-list">
          <div className="p-4 border border-slate-200 rounded-lg" data-testid="administrator-role">
            ...
            <p className="text-sm text-slate-600" data-testid="administrator-description">Full access to all features and settings</p>
          </div>
          ...
          <div className="p-4 border border-slate-200 rounded-lg" data-testid="sales-manager-role">
            ...
            <p className="text-sm text-slate-600" data-testid="sales-manager-description">Manage sales team and view all opportunities</p>
          </div>
          ...
          <div className="p-4 border border-slate-200 rounded-lg" data-testid="sales-rep-role">
            ...
            <p className="text-sm text-slate-600" data-testid="sales-rep-description">Manage own accounts, contacts, and opportunities</p>
          </div>
        </div>
      </CardContent>
    </Card>
