            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-medium text-slate-600">{t('columns.firstName')}</label>
                    <p className="font-medium text-slate-800">{contact.firstName}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-600">{t('columns.lastName')}</label>
                    <p className="font-medium text-slate-800">{contact.lastName}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-600">{t('columns.title')}</label>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <label className="text-sm font-medium text-slate-600">{t('columns.email')}</label>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <label className="text-sm font-medium text-slate-600">{t('columns.phone')}</label>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <label className="text-sm font-medium text-slate-600">{t('columns.account')}</label>
              ...
              <div className="pt-4 border-t border-slate-200">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <label className="text-slate-600">{t('columns.owner')}</label>
                    <p className="font-medium text-slate-800">{contact.owner}</p>
                  </div>
                  <div>
                    <label className="text-slate-600">{t('common:created')}</label>
